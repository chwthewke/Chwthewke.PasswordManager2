...
namespace Chwthewke.PasswordManager.Test.App.ViewModel.PasswordEditor
{
    ...
    public class GuidColorsTest : PasswordEditorTestBase
    {
        ...
        {
            // Setup
            AddPassword( "abc", PasswordGenerators.LegacyAlphaNumeric, 1, "12345".ToSecureString( ), string.Empty );
            ViewModel.UpdateMasterPassword( "12345".ToSecureString( ) );
            // Exercise
        ...
        {
            // Setup
            AddPassword( "abc", PasswordGenerators.LegacyFull, 1, "123".ToSecureString( ), string.Empty );
        ...
        {
            // Setup
            AddPassword( "abd", PasswordGenerators.LegacyFull, 1, "123".ToSecureString( ), string.Empty );
            AddPassword( "abc", PasswordGenerators.LegacyFull, 1, "123".ToSecureString( ), string.Empty );
