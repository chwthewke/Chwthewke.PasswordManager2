...
{
    [ TestFixture ]
    public class PasswordStoreSerializerTest
    {
        private PasswordStoreSerializer _serializer;
        ...
        public void SerializeEmptyPasswordStore( )
        {
            // Setup
            // Exercise
            _serializer.Serialize( _passwordStore, _outputStream );
            // Verify
        ...
        {
            return XElement.Parse( Encoding.Default.GetString( _outputStream.ToArray( ) ) );
        }
    }
}