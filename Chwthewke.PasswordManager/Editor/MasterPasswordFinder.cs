...
namespace Chwthewke.PasswordManager.Editor
{
    public class MasterPasswordFinder : IMasterPasswordFinder {
        ...
        {
            IEnumerable<PasswordDigest> candidates = _store.Passwords.GroupBy( pw => pw.MasterPasswordId ).Select( g => g.First( ) );
            PasswordDigest matchingDigest = candidates.FirstOrDefault( dig => _matcher.MatchMasterPassword( masterPassword, dig ) );
